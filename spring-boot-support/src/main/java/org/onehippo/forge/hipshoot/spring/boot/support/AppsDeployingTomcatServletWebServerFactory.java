 ...
 * </P>
 */
public class AppsDeployingTomcatServletWebServerFactory extends TomcatServletWebServerFactory {

    private static Logger log = LoggerFactory.getLogger(AppsDeployingTomcatServletWebServerFactory.class);
     ...
     */
    public AppsDeployingTomcatServletWebServerFactory(final CatalinaConfiguration catalinaConfig) {
        super();
        ...
        getSession().setPersistent(catalinaConfiguration.isPersistSession());
